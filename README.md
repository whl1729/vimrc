...
* **The Basic**: If you want something small just copy [basic.vim](https://github.com/along/vimrc/blob/master/vimrcs/basic.vim) into your ~/.vimrc and you will have a good basic setup
...
To install for multiple users, the repository needs to be cloned to a location accessible for all the intended users.
	...
	git clone git@github.com:whl1729/vimrc.git /opt/vim_runtime
...
The basic version is just one file and no plugins. Just copy [basic.vim](https://github.com/whl1729/vimrc/blob/master/vimrcs/basic.vim) and paste it into your vimrc.

The basic version is useful to install on remote servers where you don't need many plugins, and you don't do many edits.

	git clone --depth=1 git@github.com:whl1729/vimrc.git ~/.vim_runtime
